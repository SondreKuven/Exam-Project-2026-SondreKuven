  ...
  return `
        <article class="cart-item">
            ...
            <div class="cart-item-quantity">
                <span>Qty:</span>
                <button type="button" class="quantity-button" data-action="decrease" data-id="${
                  item.id
                }" aria-label="Decrease quantity">&minus;</button>
                <span class="quantity-number">${item.quantity}</span>
                <button type="button" class="quantity-button" data-action="increase" data-id="${
                  item.id
                }" aria-label="Increase quantity">&plus;</button>
            </div>

            <button type="button" class="remove-item-button" data-action="remove" data-id="${
              item.id
